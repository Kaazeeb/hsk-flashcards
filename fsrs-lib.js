(function (global, factory) {
    ...
    class AbstractScheduler {
        constructor(card, now, algorithm, strategies) {
            ...
            __publicField$5(this, "next", new Map());
    ...
    const checkParameters = (parameters) => {
        ...
        if (invalid !== void 0) {
            ...
            throw Error(`Invalid parameter length: ${parameters.length}. Must be 17, 19 or 21 for FSRSv4, 5 and 6 respectively.`);
        }
        return parameters;
    };
    ...
    const generatorParameters = (props) => {
        ...
        const w = migrateParameters(props == null ? void 0 : props.w, relearning_steps.length, enable_short_term);
        return {
    ...
    class BasicScheduler extends AbstractScheduler {
        ...
        getLearningInfo(card, grade) {
            ...
            const scheduled_minutes = Math.max(0, (_b = (_a = steps_strategy[grade]) == null ? void 0 : _a.scheduled_minutes) != null ? _b : 0);
    ...
    class FSRS extends FSRSAlgorithm {
        constructor(param) {
            super(param);
            __publicField(this, "strategyHandler", new Map());
        ...
        reschedule(current_card, reviews = [], options = {}) {
            const { recordLogHandler, reviewsOrderBy, skipManual = true, now = new Date(), update_memory_state: updateMemoryState = false } = options;
