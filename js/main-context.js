...
(function (ns) {
  ...
  const { MODES, PRACTICE_QUIZ_TYPES, ALL_SET_ID, REVIEW_ALL_SETS_ID, IMAGE_ALL_DECK_ID, SENTENCE_ALL_DECK_ID, IMAGE_SMART_SPACING_FACTOR, IMAGE_SMART_RATING_LABELS, SMART_RATINGS } = ns.constants;
